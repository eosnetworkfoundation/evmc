...
TEST(cpp, result_create)
{
    ...
    auto r = evmc::Result{EVMC_FAILURE, -1, -2, -3, -4, -5, output, sizeof(output)};
    ...
    EXPECT_EQ(r.speculative_cpu_gas_consumed, -5);
    ...
    auto c =
        evmc::make_result(r.status_code, r.gas_left, r.gas_refund, r.storage_gas_consumed, r.storage_gas_refund, r.speculative_cpu_gas_consumed, r.output_data, r.output_size);
